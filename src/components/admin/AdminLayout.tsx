...
export const TAB_ITEMS = [
  ...
  { href: '/admin/upload-docs',      icon: Upload,          label: 'Upload Docs' },
  { href: '/admin/shipment-overview',icon: Database,        label: 'Shipment Overview' },
  { href: '/admin/docs-create',      icon: FileStack,       label: 'Docs Create' },
...
export const SECTION_ITEMS = [
  { key: 'section:dashboard.total-shipments',  tabHref: '/admin/dashboard', label: 'Total Shipments card' },
  { key: 'section:dashboard.cusdec-pending',   tabHref: '/admin/dashboard', label: 'CUSDEC Pending card' },
  { key: 'section:dashboard.boatnote-pending', tabHref: '/admin/dashboard', label: 'Boat Note Pending card' },
  { key: 'section:dashboard.cdn-pending',      tabHref: '/admin/dashboard', label: 'CDN Pending card' },
  { key: 'section:dashboard.release-pending',  tabHref: '/admin/dashboard', label: 'Export Release Pending card' },
  { key: 'section:dashboard.closing-passed',   tabHref: '/admin/dashboard', label: 'Closing Time Passed warning card' },
  { key: 'section:dashboard.pending-summary',  tabHref: '/admin/dashboard', label: 'Pending Work Summary panel' },
  ...
  { key: 'section:documents-upload.admin-edit',tabHref: '/admin/upload-docs', label: 'Full Access Edit panel' },
  { key: 'section:documents-upload.bills',     tabHref: '/admin/upload-docs', label: 'Bills panel' },
  ...
  { key: 'section:boat-note.invoice',          tabHref: '/admin/docs-create', label: 'Invoice panel' },
  { key: 'section:boat-note.packing-list',     tabHref: '/admin/docs-create', label: 'Packing List panel' },
  { key: 'section:boat-note.select-cusdec',    tabHref: '/admin/docs-create', label: 'Boat Note: Select CUSDEC card' },
  { key: 'section:boat-note.select-cdn',       tabHref: '/admin/docs-create', label: 'Boat Note: Select Containers card' },
  { key: 'section:boat-note.output',           tabHref: '/admin/docs-create', label: 'Boat Note: Download / Email card' },
  { key: 'section:boat-note.done',             tabHref: '/admin/docs-create', label: 'Done Boat Note archive tab' },
  { key: 'section:boat-note.cusdec-xml',       tabHref: '/admin/docs-create', label: 'Docs Create: Cusdec XML tab' },
  { key: 'section:boat-note.cdn-text',         tabHref: '/admin/docs-create', label: 'Docs Create: CDN Text tab' },
  { key: 'section:boat-note.parties-copy',     tabHref: '/admin/docs-create', label: "Docs Create: Party's Copy tab" },
